package com.example.hanad.itunesapplication.Itunes.Collection.rockDetails.model;
...
public class RockMusicFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerRock);
    ...
    public void displayRockMusic() {
        compositeDisposable.add(
                iRequestInterfaceItunes.getRockMusicList()
                        .subscribeOn(Schedulers.newThread())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(new Consumer<RockMusicList>() {
                                       @Override
                                       public void accept(RockMusicList rockMusicLists) throws Exception {
                                           recyclerView.setAdapter(new RockMusicAdapter(RockMusicFragment.this.getActivity().getApplicationContext(), rockMusicLists.getResults(), RockMusicFragment.this, rockMusicLists, R.layout.rowitunes));
