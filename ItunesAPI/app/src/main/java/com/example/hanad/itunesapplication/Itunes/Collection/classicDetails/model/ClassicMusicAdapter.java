...
public class ClassicMusicAdapter extends RecyclerView.Adapter<ClassicMusicAdapter.MyViewHolder> {
    ...
    private ClassicMusicFragment classicMusicFragment;
    private ClassicMusicList classicMusicList;


    public ClassicMusicAdapter(Context applicationContext, List<Result> results, ClassicMusicFragment classicMusicFragment, ClassicMusicList classicMusicList, int row) {
        this.applicationContext = applicationContext;
        this.row = row;
        this.results = results;
        this.classicMusicFragment = classicMusicFragment;
