...
//progress
    ...
    public void displayClassicMusic() {
        compositeDisposable.add(
                iRequestInterfaceItunes.getClassicMusicList()
                        .subscribeOn(Schedulers.newThread())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(new Consumer<ClassicMusicList>() {
                                       @Override
                                       public void accept(ClassicMusicList classicMusicList) throws Exception {
                                           recyclerView.setAdapter(new ClassicMusicAdapter(ClassicMusicFragment.this.getActivity().getApplicationContext(), classicMusicList.getResults(), ClassicMusicFragment.this, classicMusicList, R.layout.rowitunes));
